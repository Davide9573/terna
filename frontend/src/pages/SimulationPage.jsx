...
export default function SimulationPage() {
  ...
  const [params, setParams] = useState(location.state?.params || {
    max_capacity: 100,
    k_pv: 3,
    k_w: 2,
    nuke: true
  ...
  return (
    <div className="page">
      <header className="app-header">
        <h1>Esegui la simulazione di uno scenario alternativo</h1>
        <p className="subtitle">Modifica i parametri e avvia la simulazione</p>
      </header>
      ...
      <main className="content">
        ...
        {/* Simulation criteria */}
        <div className="card">
          <h2>Criteri adottati per la simulazione</h2>
          <p>
          ...
          <p>
            ...
            - il fabbisogno puntuale di energia elettrica non viene alterato, ed è vincolato ad
